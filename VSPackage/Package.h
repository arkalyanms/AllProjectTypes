...
#include "Guids.h"
#include "..\VSPackageUI\Resource.h"

#include "..\VSPackageUI\CommandIds.h"
...
class ATL_NO_VTABLE CVSPackagePackage : 
	...
	public CComCoClass<CVSPackagePackage, &CLSID_VSPackage>,
	// Provides the implementation for IVsPackage to make this COM object into a VS Package.
	public IVsPackageImpl<CVSPackagePackage, &CLSID_VSPackage>,
	public IOleCommandTargetImpl<CVSPackagePackage>,
...
// the CVSPackagePackage object will support via QueryInterface
BEGIN_COM_MAP(CVSPackagePackage)
...
VSL_DECLARE_NOT_COPYABLE(CVSPackagePackage)
...
// This exposes CVSPackagePackage for instantiation via DllGetClassObject; however, an instance
// can not be created by CoCreateInstance, as CVSPackagePackage is specifically registered with
// VS, not the the system in general.
OBJECT_ENTRY_AUTO(CLSID_VSPackage, CVSPackagePackage)
